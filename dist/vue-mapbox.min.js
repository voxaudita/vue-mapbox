import { computed as e, isRef as t, h as a } from "vue";
import o from "map-promisified";
var i = {
    methods: {
      $_emitEvent(e, t = {}) {
  ...
  n = e => {
    const t = /^on[^a-z]/,
      a = {};
    for (const o in e) t.test(o) && (a[o] = e[o]);
    return a;
  };
const l = {
  maxBounds(e) {
...
var h = {
        ...
        watch: (function() {
          ...
          return (
            Object.entries(l).forEach(t => {
              e[t[0]] = function(e, a) {
                return d.call(this, t[0], t[1].bind(this), e, a);
              };
            }),
            e
          );
        ...
        methods: {
          ...
          $_bindPropsUpdateEvents() {
            const e = [
              ...
              t = n(this.$attrs);
            e.forEach(({ events: e, prop: a, getter: o }) => {
              e.forEach(e => {
                t["onUpdate:" + a] &&
                  this.map.on(e, this.$_updateSyncedPropsFabric(a, o));
              });
            });
          },
          $_loadMap() {
          ...
          $_bindMapEvents(e) {
            ...
            Object.keys(a).forEach(e => {
              ...
              t.includes(a) && this.map.on(a, this.$_emitMapEvent);
            });
          },
          $_unbindEvents(e) {
            e.forEach(e => {
    ...
    render() {
      return (
        this.$$_containerVNode ||
          (this.$_containerVNode = a("div", {
            id: this.container,
            ref: "container"
          })),
        a("div", { class: "mgl-map-wrapper" }, [
          this.$_containerVNode,
  ...
  u = {
    methods: {
      ...
      $_bindSelfEvents(e, t) {
        const a = n(this.$attrs);
        Object.keys(a).forEach(a => {
          const o = a.substring(2).toLowerCase();
          e.includes(o) && t.on(o, this.$_emitSelfEvent);
        });
      },
...
var S = {
    ...
    render() {
      return a("div", { style: { display: "none" } }, [this.$slots.default()]);
    }
  },
  I = {
  ...
  created() {
    this.layer.minzoom &&
      this.$watch("layer.minzoom", function(e) {
        this.initial ||
          this.map.value.setLayerZoomRange(this.layerId, e, this.layer.maxzoom);
      }),
      this.layer.maxzoom &&
          ...
          function(e) {
            if (!this.initial && e)
              for (let t of Object.keys(e))
                this.map.value.setPaintProperty(this.layerId, t, e[t]);
          },
          { deep: !0 }
        ),
      this.layer.layout &&
        this.$watch(
          ...
          function(e) {
            if (!this.initial && e)
              for (let t of Object.keys(e))
                this.map.value.setLayoutProperty(this.layerId, t, e[t]);
          },
          { deep: !0 }
        ),
      this.layer.filter &&
  ...
  methods: {
    ...
    $_bindLayerEvents(e) {
      ...
      Object.keys(a).forEach(e => {
        const a = e.substring(2).toLowerCase();
        t.includes(a) &&
          this.map.value.on(a, this.layerId, this.$_emitLayerMapEvent);
      });
    },
    $_unbindEvents(e) {
      this.map &&
        e.forEach(e => {
          this.map.value.off(e, this.layerId, this.$_emitLayerMapEvent);
        });
    },
  ...
  z = {
    ...
    computed: {
      getSourceFeatures() {
        return e =>
          this.map.value
            ? this.map.value.querySourceFeatures(this.sourceId, { filter: e })
            : null;
      },
      getRenderedFeatures() {
        return (e, t) =>
      ...
      getClusterExpansionZoom() {
        return e =>
          new Promise((t, a) => {
            ...
            this.mapSource.getClusterExpansionZoom(e, (e, o) =>
              e ? a(e) : t(o)
            );
          });
      },
      getClusterChildren() {
        return e =>
          new Promise((t, a) => {
            const o = this.mapSource;
            if (!o)
              return a(
                new Error(`Map source with id ${this.sourceId} not found.`)
              );
            o.getClusterChildren(e, (e, o) => (e ? a(e) : t(o)));
          });
      },
      getClusterLeaves() {
        return (...e) =>
          new Promise((t, a) => {
            ...
            this.mapSource.getClusterLeaves(...e, (e, o) => (e ? a(e) : t(o)));
          });
      }
    },
    created() {
    ...
    methods: {
      ...
      setFeatureState(e, t) {
        if (this.map.value) {
          ...
          return this.map.value.setFeatureState(a, t);
        }
      },
      getFeatureState(e) {
        if (this.map.value) {
      ...
      removeFeatureState(e, t, a) {
        if (this.map.value) {
          const o = { id: e, source: this.source, sourceLayer: t };
          return this.map.value.removeFeatureState(o, a);
        }
      }
    }
  },
