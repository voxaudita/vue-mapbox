!(function(e, t) {
        ...
        r.apply(e, c),
          ...
          "fitScreenCoordinates" === t &&
            ...
            (arguments.length <= 3 ? void 0 : arguments[3]) &&
              ...
              (l = O(O({}, l), arguments.length <= 3 ? void 0 : arguments[3]))),
          (p = s.map(function(t) {
            var r = t.event,
              n = t.func;
  ...
  var me = u,
    ...
    ye = z,
    ge = te,
    ve = { withEvents: u, withSelfEvents: T, asControl: z, asLayer: te },
    be = D,
    Oe = F,
    je = R,
    $e = A,
    ...
    Le = {
      ...
      methods: {
        $_deferredMount: function() {
          var e = le({ type: "vector" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
        ...
        $_addLayer: function() {
          ...
          var t = le({ id: this.layerId, source: this.sourceId }, this.layer);
          this.map.addLayer(t, this.before),
            this.$_emitEvent("added", { layerId: this.layerId });
        },
        setFeatureState: function(e, t) {
