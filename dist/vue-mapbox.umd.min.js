!(function(e, t) {
  ...
  function m(e, t, r, n) {
    var o = this;
    this.initial ||
      (d(this.$attrs)["onUpdate:".concat(e)]
  ...
  function I(e, t) {
    ...
    return function() {
      for (
        var o = [],
          i = { eventId: _(t) },
          s = S[t].events.map(function(t, r) {
            return {
              event: t,
              func: new Promise(function(n, a) {
                (o[r] = { event: t, func: E(e, t.name, i.eventId, n) }),
      ...
      try {
        r.apply(e, c),
          ...
          "fitScreenCoordinates" === t &&
            (((p = { bearing: null }).bearing = null),
            "number" ==
              typeof (arguments.length <= 2 ? void 0 : arguments[2]) &&
              (p.bearing = arguments.length <= 2 ? void 0 : arguments[2]),
            (arguments.length <= 3 ? void 0 : arguments[3]) &&
              "object" ===
                a.default(arguments.length <= 3 ? void 0 : arguments[3]) &&
              (p = O(O({}, p), arguments.length <= 3 ? void 0 : arguments[3]))),
          (l = s.map(function(t) {
            var r = t.event,
              n = t.func;
            return r.check(e, p) ? n : (e.off(r.name, n), Promise.resolve());
          }));
      } catch (t) {
  ...
  var D = {
        ...
        methods: {
          ...
          $_bindMapEvents: function(e) {
            ...
            Object.keys(n).forEach(function(e) {
              var n = e.substring(2).toLowerCase();
              r.includes(n) && t.map.on(n, t.$_emitMapEvent);
            });
          },
    ...
    provide: function() {
      var e = this;
      return {
        mapbox: r.computed(function() {
          return e.mapbox;
        }),
        map: r.computed(function() {
          return r.isRef(e.map) ? e.map.value : e.map;
        }),
        actions: r.computed(function() {
          return e.actions;
        })
      };
    },
  ...
  var T = {
    ...
    F = {
      ...
      created: function() {
        var e = this.mapbox.value.GeolocateControl;
    ...
    W = {
      ...
      mounted: function() {
        ...
        this.$slots.marker && (t.element = this.$slots.marker[0].elm),
          (this.marker = new this.mapbox.value.Marker(t)),
          d(this.$attrs)["onUpdate:coordinates"] &&
        ...
        $_bindMarkerDOMEvents: function() {
          ...
          Object.keys(t).forEach(function(t) {
            ...
            Object.values(V).includes(r) &&
              e.marker._element.addEventListener(r, function(t) {
                e.$_emitSelfEvent(t);
              });
          });
        },
    ...
    J = {
      ...
      methods: {
        $_addPopup: function() {
          ...
          this.$_bindSelfEvents(Object.keys(H), this.popup),
    ...
    te = {
      ...
      computed: {
        sourceLoaded: function() {
          return !!this.map && this.map.value.isSourceLoaded(this.sourceId);
        },
        mapLayer: function() {
              ...
              function(e) {
                if (!this.initial && e)
                  for (var t = 0, r = Object.keys(e); t < r.length; t++) {
                    var n = r[t];
                    this.map.value.setPaintProperty(this.layerId, n, e[n]);
                  }
              },
              { deep: !0 }
            ),
            ...
            this.$watch(
              ...
              function(e) {
                if (!this.initial && e)
                  for (var t = 0, r = Object.keys(e); t < r.length; t++) {
                    var n = r[t];
                    this.map.value.setLayoutProperty(this.layerId, n, e[n]);
                  }
              },
              { deep: !0 }
            ),
      ...
      methods: {
        ...
        $_bindLayerEvents: function(e) {
          ...
          Object.keys(n).forEach(function(e) {
            var n = e.substring(2).toLowerCase();
            r.includes(n) &&
              t.map.value.on(n, t.layerId, t.$_emitLayerMapEvent);
          });
        },
        $_unbindEvents: function(e) {
          var t = this;
          this.map &&
            e.forEach(function(e) {
              t.map.value.off(e, t.layerId, t.$_emitLayerMapEvent);
            });
        },
        ...
        move: function(e) {
          this.map.value.moveLayer(this.layerId, e),
  ...
  var me = u,
    ...
    ye = z,
    ve = te,
    ge = { withEvents: u, withSelfEvents: T, asControl: z, asLayer: te },
    be = D,
    Oe = R,
    je = F,
    $e = A,
    ...
    Se = {
      ...
      computed: {
        getSourceFeatures: function() {
          ...
          return function(t) {
            return e.map.value
              ? e.map.value.querySourceFeatures(e.sourceId, { filter: t })
              : null;
          };
        },
        getRenderedFeatures: function() {
          ...
          return function(t, r) {
            return e.map.value
              ? e.map.value.queryRenderedFeatures(t, {
                  layers: [e.layerId],
                  filter: r
                })
              : null;
      ...
      methods: {
        ...
        $_addLayer: function() {
          var e = this.map.value.getLayer(this.layerId);
          if (e) {
            if (!this.replace)
              return (
        ...
        setFeatureState: function(e, t) {
          if (this.map.value) {
            ...
            return this.map.value.setFeatureState(r, t);
          }
        },
        ...
        removeFeatureState: function(e, t, r) {
          if (this.map.value) {
            ...
            return this.map.value.removeFeatureState(n, r);
          }
        }
      }
    },
    _e = {
      ...
      methods: {
        $_deferredMount: function() {
          var e = ie({ type: "image" }, this.source);
    ...
    Ee = {
      ...
      methods: {
        $_deferredMount: function() {
          var e = se({ type: "canvas" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    Ie = {
      ...
      methods: {
        $_deferredMount: function() {
          var e = ue({ type: "video" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    Le = {
      ...
      computed: {
        getSourceFeatures: function() {
          ...
          return function(t) {
            return e.map
              ? e.map.value.querySourceFeatures(e.sourceId, {
    ...
    xe = {
      ...
      methods: {
        $_deferredMount: function() {
          var e = he({ type: "raster" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    Me = J;
  (e.$helpers = ge),
    (e.MglAttributionControl = Pe),
    (e.MglCanvasLayer = Ee),
    (e.MglFullscreenControl = $e),
    (e.MglGeojsonLayer = Se),
    (e.MglGeolocateControl = je),
    (e.MglImageLayer = _e),
    (e.MglMap = be),
    (e.MglMarker = ke),
    (e.MglNavigationControl = Oe),
    (e.MglPopup = Me),
    (e.MglRasterLayer = xe),
    (e.MglScaleControl = we),
    (e.MglVectorLayer = Le),
    (e.MglVideoLayer = Ie),
    (e.asControl = ye),
    (e.asLayer = ve),
